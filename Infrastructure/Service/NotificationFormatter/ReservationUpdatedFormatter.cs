...
{   
    ...
    public class ReservationUpdatedFormatter : INotificationFormatter
    {
        ...
        public bool CanHandle(NotificationType type) =>
            type == NotificationType.ReservationUpdated;              
        ...
        public Task<string> FormatAsync(Notification n, User user)
        {
            ...
            <html>
              <body>
                ...
                <p>✅ Tu reserva ha sido <b>actualizada</b> correctamente.</p>
                <hr/>
